...
\newcommand{\Gdatum}{01.10.2015} %Gründungsdatum
\newcommand{\Ort}{Kiel, Fraunhoferstr. 4-5, 24118 Kiel} %Sitz des Vereins
\newcommand{\VorstandEins}{Ruben Barkow}
\newcommand{\VorstandZwei}{Felix von Courten}
\newcommand{\Schatzmeister}{Robert }
%======================================================
...
\begin{enumerate}
\item Der Verein führt den Namen „\Verein“ ( im folgenden Verein genannt) 
\item Der Sitz des Vereines ist \Ort 
\item Der Verein ist in das Vereinsregister der Stadt \Ort einzutragen und trägt danach den Namen „\Verein e.V.“ 
...
\item Mitglieder des Vorstands haften dem Verein nur für grob fahrlässige und vorsätzliche Schädigung
\end{enumerate}
